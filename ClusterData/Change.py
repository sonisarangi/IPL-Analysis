...
datafile = open('OldBatsmanClusterData.csv', 'r')
datareader = csv.reader(datafile,delimiter=',')
batdata = []
for row in datareader:
	batdata.append(row)    

datafile = open('OldBowlerClusterData.csv', 'r')
datareader = csv.reader(datafile,delimiter=',')
bowldata = []
for row in datareader:
	bowldata.append(row)    
...
with open("BatsmanClusterData.csv", "w") as f:
    writer = csv.writer(f)
    writer.writerows(batdata)

with open("BowlerClusterData.csv", "w") as f:
    writer = csv.writer(f)
